...
# Dhanify — AI-Powered Personal Finance Management platform
...
<p align="center">Explore the Dhanify dashboard layout at a glance.</p>

<div align="center">
    <img src="public/docs/dashboard-page.png" alt="Dhanify dashboard view" style="max-width:100%; border-radius:16px; box-shadow:0 16px 32px rgba(15,23,42,0.2);" />
</div>

<h3 align="center">Schema Overview</h3>

<p align="center">
    <img src="public/docs/dhanify schema.svg" alt="Dhanify relational schema" width="880" style="border-radius:12px; box-shadow:0 16px 32px rgba(15,23,42,0.2);" />
    <br />
...
**Vercel AI Elements** drive a conversational surface that blends short-term context with long-term embeddings. LangGraph routes between analysis, insight, and action nodes so Dhanify can summarize budgets, draft next steps, or queue transactions just by chatting.
...
<!-- <p align="center">
    <img src="public/docs/project-architecture.png" alt="Dhanify relational schema" width="880" style="border-radius:12px; box-shadow:0 16px 32px rgba(15,23,42,0.2);" />
    <br />
...
NODEMAILER_USER=alerts@dhanify.app
NODEMAILER_PASS=app-specific-password
EMAIL_ALERT_FROM="Dhanify Alerts <alerts@dhanify.app>"
```
